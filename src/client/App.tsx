...
function Admin() {
  ...
  type AdminTab = "resource-add" | "work-add" | "resource-list" | "work-list";
...
function AdminMobileNav({ active, onChange }: { active: "resource-add" | "work-add" | "resource-list" | "work-list"; onChange: (tab: "resource-add" | "work-add" | "resource-list" | "work-list") => void }) {
  const items = [
